...
Diese ZIP enthält die Web-App 7.0.0-beta.1 direkt auf einer Ebene. Sie ist eine Weiterentwicklung deiner bisherigen Version 6.3.1.
...
4. Die bisherige App-Adresse online öffnen. Für den ersten Wechsel von V6 alle geöffneten ROLEPLAY-Fenster und die installierte PWA schließen, anschließend neu öffnen. Am Seitenende steht `ROLEPLAY 7.0.0-beta.1`. Browserdaten dabei nicht löschen.
