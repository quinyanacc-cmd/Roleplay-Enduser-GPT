...
function neutralRoutines() {
  return {
    morning: { key: "morning", title: "Morgenroutine", description: "Bewusst in den Tag", theme: "morning", autoNext: false,
      items: [{ id: "neutral-water", emoji: "💧", title: "Wasser trinken", minutes: 1, context: "" }, { id: "neutral-plan", emoji: "📝", title: "Einen kleinen Schritt für heute wählen", minutes: 3, context: "Was passt heute zu deiner Energie und deinen Aufgaben?" }] },
    evening: { key: "evening", title: "Abendroutine", description: "Den Tag abschließen", theme: "evening", autoNext: false,
      items: [{ id: "neutral-review", emoji: "📖", title: "Auf den Tag zurückblicken", minutes: 3, context: "Was hat dir heute geholfen?" }, { id: "neutral-tomorrow", emoji: "🌙", title: "Morgen vorbereiten", minutes: 2, context: "" }] }
  };
}
